    ...
    >
      <button
        ...
        style={{
          ...
          background: "rgba(4,20,10,0.9)", border: "1px solid rgba(74,222,128,0.2)",
          borderRadius: "8px", padding: "10px", cursor: "pointer",
          color: "rgba(134,239,172,0.7)", transition: "all 0.2s ease",
        }}
      ...
      <div
        style={{ position: "relative", maxWidth: "860px", width: "90vw", margin: "0 80px" }}
      ...
      >
        <img
          ...
          style={{
            ...
            boxShadow: "0 40px 80px rgba(0,0,0,0.8), 0 0 40px rgba(22,163,74,0.08)",
          }}
        />
        <div style={{ marginTop: "16px", textAlign: "center" }}>
          <span style={{
            ...
            background: "rgba(22,163,74,0.15)", border: "1px solid rgba(74,222,128,0.3)",
            color: "#4ade80", padding: "4px 12px", borderRadius: "3px", marginRight: "10px",
          }}>{item.tag}</span>
          <span style={{ fontFamily: "'Syne', sans-serif", color: "#fff", fontSize: "15px", fontWeight: 600 }}>
            {item.label}
          </span>
        </div>
        <p style={{ textAlign: "center", fontFamily: "'DM Mono', monospace", fontSize: "11px", color: "rgba(134,239,172,0.35)", marginTop: "8px" }}>
      ...
      <button
        ...
        style={{
          ...
          color: "rgba(134,239,172,0.7)", display: "flex", alignItems: "center", justifyContent: "center",
        }}
      >
        <X size={18} />
      </button>
  ...
  return (
    <NavLayout>
      <style>{`
        ...
        /* ── Body ── */
        .pl-body { max-width: 1280px; margin: 0 auto; padding: 64px 32px; }

        /* ── Top grid: products + gallery ── */
        .pl-top-grid {
        ...
        .pl-section-eyebrow {
          ...
          color: #4ade80; text-transform: uppercase; margin-bottom: 10px;
          display: flex; align-items: center; gap: 10px;
        }
        .pl-section-eyebrow::before {
          content: ''; display: inline-block; width: 24px; height: 1px; background: #4ade80;
        }
        .pl-section-title {
        ...
        .pl-product-item {
          ...
          background: rgba(4,20,10,0.7); border: 1px solid rgba(74,222,128,0.1);
          border-radius: 6px; padding: 14px 16px; margin-bottom: 8px;
          transition: all 0.2s ease;
        }
        .pl-product-item:hover { border-color: rgba(74,222,128,0.25); background: rgba(4,20,10,0.9); }
        ...
        .pl-meta-card {
          background: rgba(4,20,10,0.8); border: 1px solid rgba(74,222,128,0.15);
        ...
        .pl-meta-card-label {
          font-weight: 700; font-size: 14px; color: #fff; margin: 8px 0 4px;
        }
        .pl-meta-card-sub {
        ...
        .pl-gallery-btn {
          ...
          aspect-ratio: 1; background: rgba(4,20,10,0.8);
          border: 1px solid rgba(74,222,128,0.1); cursor: pointer;
          transition: border-color 0.25s ease, box-shadow 0.25s ease;
        }
        .pl-gallery-btn:hover {
          border-color: rgba(74,222,128,0.3);
          box-shadow: 0 8px 30px rgba(0,0,0,0.5), 0 0 16px rgba(22,163,74,0.08);
        }
        .pl-gallery-btn img {
          width: 100%; height: 100%; object-fit: cover;
          transition: transform 0.5s ease; filter: brightness(0.88);
        }
        .pl-gallery-btn:hover img { transform: scale(1.08); filter: brightness(0.95); }
        .pl-gallery-overlay {
        ...
        .pl-gallery-hint {
          ...
          color: rgba(134,239,172,0.35); margin-top: 8px; text-align: center;
        }

        /* ── Bottom 3-col grid ── */
        .pl-bottom-grid {
          display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px;
          border-top: 1px solid rgba(74,222,128,0.08); padding-top: 56px;
        }
        .pl-info-card {
          background: rgba(4,20,10,0.7); border: 1px solid rgba(74,222,128,0.1);
        ...
        .pl-info-card:hover { border-color: rgba(74,222,128,0.22); transform: translateY(-3px); }
        ...
        .pl-custom-item {
          ...
          color: rgba(134,239,172,0.6); margin-bottom: 4px;
        }
        .pl-custom-dot { width: 5px; height: 5px; border-radius: 50%; background: rgba(74,222,128,0.4); flex-shrink: 0; }
        ...
        .pl-step-num {
          ...
          background: rgba(22,163,74,0.15); border: 1px solid rgba(74,222,128,0.25);
          display: flex; align-items: center; justify-content: center;
          font-family: 'DM Mono', monospace; font-size: 11px; font-weight: 500; color: #4ade80;
          margin-top: 1px;
        }
        .pl-step-title {
        ...
        .pl-step-desc {
          font-family: 'DM Mono', monospace; font-size: 11px; font-weight: 300;
          color: rgba(134,239,172,0.45); line-height: 1.5;
        }
        ...
        .pl-quality-item {
          ...
          font-family: 'DM Mono', monospace; font-size: 12px; font-weight: 300;
          color: rgba(134,239,172,0.6); margin-bottom: 6px; line-height: 1.4;
        }

        /* ── CTA ── */
        .pl-cta {
          border-top: 1px solid rgba(74,222,128,0.08);
          padding: 64px 32px 80px; text-align: center; position: relative; overflow: hidden;
        }
        .pl-cta::before {
          content: ''; position: absolute; inset: 0;
          background-image:
        ...
        .pl-cta p {
          font-family: 'DM Mono', monospace; font-size: 14px; font-weight: 300;
          color: rgba(134,239,172,0.55); margin: 0 0 32px; line-height: 1.7;
        }
        .pl-cta-btn {
          display: inline-flex; align-items: center; gap: 8px;
        ...
        @media (max-width: 1024px) {
          .pl-bottom-grid { grid-template-columns: 1fr 1fr; }
        }
                ...
                {packagingSamples.map((sample, idx) => (
                  <button key={sample.id} className="pl-gallery-btn" onClick={() => setLightboxIdx(idx)} aria-label={`View ${sample.label}`}>
                    ...
                    <div className="pl-gallery-overlay">
                      <ZoomIn size={20} color="rgba(134,239,172,0.8)" />
                      <div className="pl-gallery-tag">{sample.tag}</div>
                    </div>
                  </button>
                ))}
              </div>
